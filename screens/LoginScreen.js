  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={{marginHorizontal: 25}}>
        <View style={{alignItems: 'center', marginBottom: 40}}></View>
        <Text
          style={{
            fontSize: 28,
            fontWeight: '500',
        ...
        <TouchableOpacity style={styles.loginbutton} onPress={GetOTP}>
          <Text style={styles.login}>SEND OTP</Text>
        </TouchableOpacity>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <TouchableOpacity onPress={() => {}} style={styles.gicon}>
            <Image
...
const styles = StyleSheet.create({
  ...
  image: {width: 225, height: 225, transform: [{rotate: '-15deg'}]},
  textinput: {
    flexDirection: 'row',
    paddingTop: 5,
    paddingLeft: 3,
